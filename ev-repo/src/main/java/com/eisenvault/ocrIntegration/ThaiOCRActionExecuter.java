 ...
 */
public class ThaiOCRActionExecuter extends OCRMethods {

	


	private static final String NAME = "Thai-OCR";
	...
	public void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
		...
		this.executeOCR(ruleAction, actionedUponNodeRef, NAME, "Thai");
