...
public abstract class OCRMethods extends ActionExecuterAbstractBase {
	...
	protected void executeOCR(Action ruleAction, NodeRef actionedUponNodeRef, String NAME, String ocrLanguageParam)
	{
		...
		try {
			...
			String sourceMimetype = contentData.getMimetype();   // to find the format of file 
			...
			if (sourceMimetype.equalsIgnoreCase("application/pdf")
				...
				System.out.println(ocrLanguageParam);
				
				String[] hello = new String[3];
				String path=sourceFile.getAbsolutePath();
				String output=targetFile.getAbsolutePath();
				String lang=ocrLanguageParam;
				
				hello[0]=lang;
				hello[1]=path;
				hello[2]=output;
				
				Vector<String> argList = new Vector<String>(Arrays.asList(hello));
				
				
				AbbyOCR.NewClass2.performRecognition(argList);
