 ...
 */
public class EnglishOCRActionExecuter extends OCRMethods {

	


	private static final String NAME = "English-OCR";
	...
	public void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
		...
		this.executeOCR(ruleAction, actionedUponNodeRef, NAME, "English");
